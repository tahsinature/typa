...
// Persisted to localStorage (shared across windows of the same origin), so a
// newly opened window inherits the current theme / layout / zoom — and these
// prefs also survive app restarts.
export const useSettingsStore = create<SettingsStore>()(
  persist(
    ...
    }),
    {
      ...
      // resolvedTheme is derived, not persisted — it's recomputed on rehydrate.
      partialize: (s) => ({
        theme: s.theme,
        layout: s.layout,
        fontSize: s.fontSize,
